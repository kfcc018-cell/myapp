...
오른쪽 상단 관리자 버튼으로 누구나 접근해 항목 설명과 사진을 등록할 수 있습니다. JPG/PNG/WEBP, 5MB 이하를 지원합니다. 새 등록 사진은 JPEG로 변환해 Supabase Storage의 boss-worldcup-images 공개 버킷에 저장합니다. 버킷은 서버 키가 설정된 상태에서 첫 등록 시 생성합니다. 기존 외부 이미지 항목도 계속 표시됩니다. 등록된 항목은 새 게임 후보에 포함됩니다.
